...
import Yupiter from "./pages/Yupiter";
import Merkuriy from "./pages/Merkuriy";
import Yer from "./pages/Yer";
import Venera from "./pages/Venera";
import Uran from "./pages/Uran";
    ...
    const data:CardData[]=[
      {
        ...
        "images": {
          ...
          "geologys": "./assets/favicon-32x32.png"
        }
      },
      {
        "name": "Venus",
        ...
        "images": {
          ...
          "geologys": "./assets/geology-venus.png"
        }
      },
      {
        "name": "Earth",
        ...
        "images": {
          ...
          "geologys": "./assets/geology-earth.png"
        }
      },
      {
        "name": "Mars",
        ...
        "images": {
          ...
          "geologys": "./assets/geology-mars.png"
        }
      },
      {
        "name": "Jupiter",
        ...
        "images": {
          ...
          "geologys": "./assets/geology-jupiter.png"
        }
      },
      {
        "name": "Saturn",
        ...
        "images": {
          ...
          "geologys": "./assets/geology-saturn.png"
        }
      },
      {
        "name": "Uranus",
        ...
        "images": {
          ...
          "geologys": "./assets/geology-uranus.png"
        }
      },
      {
        "name": "Neptune",
        ...
        "images": {
          ...
          "geologys": "./assets/geology-neptune.png"
        }
      }
    ]
    return (
      <BrowserRouter>
        <Routes>
          <Route
            path="/"
            element={<Merkuriy data={data} />}
          />
          <Route path="/Venera" element={<Venera data={data} />} />
          <Route path="/Yer" element={<Yer data={data} />} />
          <Route path="/Mars" element={<Mars data={data} />} />
          <Route path="/Yupiter" element={<Yupiter data={data} />} />
          <Route path="/Saturn" element={<Saturn data={data} />} />
          <Route path="/Uran" element={<Uran data={data} />} />
          <Route path="/Neptun" element={<Neptun data={data} />} />
        </Routes>
      </BrowserRouter>
    );
  }
